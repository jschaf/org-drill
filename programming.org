...
This advice is a little suspect.  Java compilers may use StringBuilder
optimization.  Thus, we should probably prefer concatenation because it's
shorter.
...
:DRILL_EASE: 2.18
:DRILL_LAST_QUALITY: 4
:DRILL_LAST_REVIEWED: [2016-02-14 Sun 11:13]
:END:

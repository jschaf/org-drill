...
*** How big is an signed integer                                      :drill:
    ...
    :DRILL_EASE: 2.6
    :DRILL_LAST_QUALITY: 5
    :DRILL_LAST_REVIEWED: [2016-02-16 Tue 10:46]
    :END:
...
*** Double Range                                                      :drill:
    ...
    :DRILL_EASE: 2.6
    :DRILL_LAST_QUALITY: 5
    :DRILL_LAST_REVIEWED: [2016-02-16 Tue 10:42]
    :END:
...
When should prefer distinguished return values over state checking for control
flow in an API?
